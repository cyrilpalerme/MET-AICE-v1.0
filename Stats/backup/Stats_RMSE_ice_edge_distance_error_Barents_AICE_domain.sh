#!/bin/bash -f
#$ -N PCAPS_SIC_ice_edge_verification
#$ -l h_rt=02:00:00
#$ -S /bin/bash
#$ -pe shmem-1 1
...
python3 /lustre/storeB/users/cyrilp/AICE/Scripts/Paper/Stats/Stats_RMSE_ice_edge_distance_error_Barents_AICE_domain.py
